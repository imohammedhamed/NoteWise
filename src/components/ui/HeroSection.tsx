...
export default function HeroSection() {
  return (
    <section className=" mt-40 flex justify-center items-center w-full">
        ...
        <span className=" w-full flex justify-center items-center pt-7  pb-10 *:text-base *:font-semibold">
        <Button className="mx-2"><Link href="/login" className="lg:text-base text-sm">Get Started for Free</Link></Button>
        <Button className="mx-2" variant="ghost"><Link href="/#about" className="lg:text-base text-sm">Learn More</Link></Button>
        </span>
        <Image src={heroImg} alt="hero img" className=" p-5 rounded-xl bg-DarkPurple/10 backdrop-blur-xl "/>
        </MaxWContainer>
    </section>
  )
}
