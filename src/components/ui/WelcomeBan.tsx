...
export default function WelcomeBan({Welcome_to}:WelcomeBanProps) {
  return (
    ...
    <h1 className=' text-3xl lg:text-4xl md:text-4xl font-bold text-brand_primary pt-5'>{Welcome_to} to <span className='bg-gradient-to-r from-transparent to-brand_primary/50 rounded-xl bg-clip-content'>NoteWise</span></h1>
    </div>
  )
}
