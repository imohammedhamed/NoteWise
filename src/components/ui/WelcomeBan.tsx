...
export default function WelcomeBan({Welcome_to}:WelcomeBanProps) {
  return (
    ...
    <h1 className=' text-3xl lg:text-4xl md:text-4xl font-bold text-DarkPurple pt-5'>{Welcome_to} to <span className='bg-gradient-to-r from-LightPurple/5 to-Purple700/30 rounded-xl bg-clip-content'>NoteWise</span></h1>
    </div>
  )
}
