...
export default function UserNotesNotFound({NoteTableId,NoteTableName}:UserNotesNotFoundProps) {
  return (
      <div className=" my-10 w-full flex flex-col justify-center items-center gap-5">
          ...
          <p className=" text-base font-extrabold text-DarkPurple">Your {NoteTableName} Table looks empty</p>
          <p className=" text-sm text-DarkPurple/50 font-extrabold">What are you waiting for?</p>
          </span>
